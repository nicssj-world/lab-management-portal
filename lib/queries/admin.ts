...
const CRUD_ACTIONS = [
  ...
  'lab_map.evacuation.plan.create', 'lab_map.evacuation.plan.update',
  'lab_map.evacuation.drill_cycle.create', 'lab_map.evacuation.drill_session.create',
  'lab_map.evacuation.drill_session.update',
  ...
  'chemical_safety.sds.draft_update', 'chemical_safety.sds.submit', 'chemical_safety.sds.review',
  'chemical_safety.sds.supersede', 'chemical_safety.sds.publish', 'chemical_safety.sds.publish_link',
  'chemical_safety.change_request.submit', 'chemical_safety.change_request.review',
  'chemical_safety.department_change_request.review', 'chemical_safety.department_holding_change_request.review',
  'chemical_safety.registry_entry.review',
  ...
  'chemical_safety.department_sds.link_existing', 'chemical_safety.department_sds.register_sds_only',
  ...
  'kpi.satisfaction.manual.upsert', 'kpi.satisfaction.metric.create', 'kpi.satisfaction.metric.update',
  ...
  'quality_task.attachment.upload', 'quality_task.attachment.delete', 'quality_task.check_in', 'quality_task.check_in.open',
  ...
  'risk_team_members.grant', 'risk_team_members.revoke',
  ...
  'personnel.team_org.assign', 'personnel.team_org.remove',
