...
export function createClient() {
  ...
  if (!browserClient) {
    browserClient = createBrowserClient(
      ...
      {
        // Keep ownership of the singleton in this module. @supabase/ssr's
        // hidden cache can outlive a Turbopack refresh and return a client
        // created with the old autoRefreshToken setting.
        isSingleton: false,
        auth: {
