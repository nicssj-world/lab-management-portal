...
assert.match(staff, /satisfaction-hero/, 'staff survey page should have a purpose-built hero')
assert.match(staff, /satisfaction-hero-metric/, 'staff hero should surface useful at-a-glance metrics')
