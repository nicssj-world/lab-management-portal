...
assert.match(staff, /SatisfactionSummaryCard/, 'staff metrics should use cohesive summary cards')
assert.match(primitives, /satisfaction-summary-card/, 'summary cards keep a cohesive surface class')
