...
insert into role_permissions (role, resource, level) values
  ...
  ('Admin', 'ข่าวสาร',                'edit'),
  ('Admin', 'ความเสี่ยง',              'edit'),
  ('Admin', 'Rejection',               'edit'),
  ('Admin', 'สัญญา',                  'edit'),
  ('Admin', 'Workload',               'edit'),
  ('Admin', 'KPI',                    'edit'),
  ...
  ('Manager', 'ความเสี่ยง',              'edit'),
  ('Manager', 'Rejection',               'edit'),
  ('Manager', 'สัญญา',                  'edit'),
  ...
  ('Medical Technologist', 'ความเสี่ยง',              'view'),
  ('Medical Technologist', 'Rejection',               'view'),
  ...
  ('Assistant', 'ความเสี่ยง',              'none'),
  ('Assistant', 'Rejection',               'none'),
