...
('Manager', 'ความเสี่ยง:edit',          true),
('Manager', 'Rejection:edit',           true),
...
('Medical Technologist', 'ความเสี่ยง:view',          true),
('Medical Technologist', 'Rejection:view',           true),
...
('Assistant', 'ความเสี่ยง:view',          true),
('Assistant', 'Rejection:view',           true),
