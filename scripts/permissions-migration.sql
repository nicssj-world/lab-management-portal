...
insert into role_permissions (role, resource, granted) values
  ...
  ('Admin', 'ข่าวสาร',                true),
  ('Admin', 'ความเสี่ยง',             true),
  ('Admin', 'Rejection',              true),
  ('Admin', 'สัญญา',                  true),
  ...
  ('Manager', 'ความเสี่ยง',             true),
  ('Manager', 'Rejection',              true),
  ('Manager', 'สัญญา',                  true),
  ...
  ('Medical Technologist', 'ความเสี่ยง',             false),
  ('Medical Technologist', 'Rejection',              false),
  ...
  ('Assistant', 'ความเสี่ยง',             false),
  ('Assistant', 'Rejection',              false),
