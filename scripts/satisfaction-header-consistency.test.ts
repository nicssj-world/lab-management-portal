...
const primitives = readFileSync(resolve(process.cwd(), 'components/satisfaction/SatisfactionPrimitives.tsx'), 'utf8')
...
assert.ok(module.includes('SatisfactionSummaryCard') && primitives.includes('satisfaction-summary-card'), 'keeps KPI information in the dashboard content')
