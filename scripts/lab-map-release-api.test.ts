...
assert.ok(list.includes('manifestHashForSnapshots'))
assert.ok(list.includes('safetyAssetSnapshot'))
assert.ok(list.includes('assemblyPointSnapshot'))
assert.ok(list.includes('asset_snapshot'))
assert.ok(list.includes('assembly_point_snapshot'))
...
assert.ok(publish.includes('manifestHashForSnapshots'))
assert.ok(publish.includes('safetyAssetSnapshot'))
