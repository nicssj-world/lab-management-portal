...
assert.ok(module.includes('<div className="satisfaction-module satisfaction-page"'), 'uses a container rather than nesting a second main landmark')
assert.ok(css.includes('.satisfaction-module .satisfaction-page { width: 100%; max-width: none;'), 'fills the available protected content width')
