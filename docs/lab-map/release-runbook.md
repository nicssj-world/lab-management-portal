...
2. เดินตรวจ main/alternate preset จากทุก station โดยเทียบกับป้ายจริง ไม่คำนวณเส้นทางใหม่
3. ตรวจประตูห้องควบคุมไฟฟ้าที่ล็อคถาวร จุดสแกน โซน PPE ห้องเย็น และโซนคลังวัสดุ
4. ให้ผู้รับผิดชอบควบคุมการติดเชื้อทบทวน classification
5. ตรวจ A3/A4 และ QR ที่ระยะติดตั้งจริง ลงนามและเก็บหลักฐาน
...
6. ตรวจ activity log สำหรับ `lab_map.release.publish` และการกำหนดพื้นที่บุคลากรที่เกี่ยวข้อง
