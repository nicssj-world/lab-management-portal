...
ผู้รับผิดชอบอ่านจากไฟล์ `00 ผู้รับผิดชอบ IT` ในโฟลเดอร์ปีเดียวกัน แล้วจับคู่ชื่อสั้นกับ
profile ที่ active เพื่อมอบหมาย UUID โดยยึดหน่วยงานในชีท แม้ `profiles.dept` จะต่างกัน
หากไม่พบหรือพบชื่อซ้ำ ตัวนำเข้าจะหยุดก่อนเขียนข้อมูล
...
(UUID นี้เป็นผู้ทำรายการและ audit ไม่ใช่ UUID ผู้รับผิดชอบจากชีท):
