...
const DOCUMENT_WORKFLOW_EDIT_ROLES = ['Laboratory Director', 'Quality Manager', 'Document Controller', 'Reviewer', 'Viewer']
...
export default async function DocumentsPage() {
  ...
  const hasWorkflowAccess = DOCUMENT_WORKFLOW_EDIT_ROLES.includes(actor?.doc_role ?? '')
