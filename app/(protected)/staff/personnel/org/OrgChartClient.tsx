  ...
  return (
    <div style={{ display: 'flex', flexDirection: 'column', gap: 16 }}>
      ...
      <div style={{ display: 'flex', alignItems: 'center', gap: 12, flexWrap: 'wrap' }}>
        ...
        <Link href="/staff/personnel/team-org" style={{ ...btn, textDecoration: 'none', maxWidth: '100%', minWidth: 0, boxSizing: 'border-box', whiteSpace: 'normal', textAlign: 'left' }}><Icon name="users" size={15} /> เจ้าหน้าที่กลุ่มงานเทคนิคการแพทย์</Link>
