...
revoke all on function public.replace_equipment_pm_cal_plans(uuid, integer, jsonb, uuid) from public, anon, authenticated;
grant execute on function public.replace_equipment_pm_cal_plans(uuid, integer, jsonb, uuid) to service_role;
