...
| ความปลอดภัย → ห้องสารเคมี / SDS | — (Admin/Manager/safety editor หรือผู้ได้รับมอบหมายตาม `chemical_role_scopes`) | `/staff/lab-map/chemicals?view=overview\|layout\|registry\|imports`, `/staff/lab-map/sds?view=chemicals\|departments`; public `/sds` (ไม่ต้องล็อกอิน) | `/api/admin/chemical-safety/*`, public `/api/public/sds/*`, `/api/public/department-sds/*`, `/api/public/safety-manual/MN-LAB-02` |
