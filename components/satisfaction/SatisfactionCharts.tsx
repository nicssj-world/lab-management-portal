...
export function SatisfactionCharts({ data }: { data: SurveyDashboardData }) {
  ...
  return (
    <div className="satisfaction-chart-grid">
      <style>{`.satisfaction-chart-grid{display:grid;grid-template-columns:1fr 1fr;gap:14px}.satisfaction-chart-wide{grid-column:1/-1}.chart-box{height:280px}.satisfaction-chart-table{width:100%;border-collapse:collapse;margin-top:12px;font-size:11.5px}.satisfaction-chart-table th,.satisfaction-chart-table td{padding:7px 8px;border-top:1px solid var(--border);text-align:left;color:var(--ink)}.satisfaction-chart-table th{color:var(--muted)}.satisfaction-question-table th:first-child,.satisfaction-question-table td:first-child{width:70%;white-space:normal;overflow-wrap:anywhere;line-height:1.55}.satisfaction-question-table th:nth-child(2),.satisfaction-question-table td:nth-child(2){width:18%;white-space:nowrap}.satisfaction-question-table th:nth-child(3),.satisfaction-question-table td:nth-child(3){width:12%;white-space:nowrap}@media(max-width:900px){.satisfaction-chart-grid{grid-template-columns:1fr}.satisfaction-chart-wide{grid-column:auto}}@media(max-width:520px){.chart-box{height:240px}.satisfaction-question-table{font-size:12px}.satisfaction-question-table th:first-child,.satisfaction-question-table td:first-child{width:auto}}`}</style>
