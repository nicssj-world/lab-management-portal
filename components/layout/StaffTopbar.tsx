...
const PAGE_TITLES: Record<string, { th: string; en: string }> = {
  ...
  '/staff/risk':             { th: 'ภาพรวมความเสี่ยง',              en: 'Risk Overview' },
  '/staff/risk/report':      { th: 'รายงานอุบัติการณ์',             en: 'Report an Incident' },
  '/staff/risk/ior':         { th: 'ทะเบียนอุบัติการณ์ (IOR)',      en: 'Incident Reports' },
  '/staff/risk/register':    { th: 'ทะเบียนความเสี่ยง',             en: 'Risk Register' },
  '/staff/risk/smart-rm':    { th: 'วิเคราะห์ข้อมูล Smart-RM',      en: 'Smart-RM Analytics' },
  ...
  '/staff/lab-map/safety-assets': { th: 'อุปกรณ์ความปลอดภัย', en: 'Safety Equipment' },
  '/staff/lab-map/evacuation': { th: 'จุดรวมพล / แผนอพยพ', en: 'Assembly Points / Evacuation Plan' },
  '/staff/lab-map/print':    { th: 'ส่งออกแผนที่ห้องปฏิบัติการ', en: 'Export Laboratory Map' },
  '/staff/lab-map/sds':      { th: 'สารเคมีและ SDS', en: 'Chemicals & SDS' },
