...
export function LabMapPrintSheet({ dto }: { dto: MapPrintDTO }) {
  ...
  return (
    <article className="lab-map-print-sheet" data-map-print-sheet data-paper-size={dto.paperSize}>
      ...
      <div className="lab-map-print-map">
        <LabMapCanvas map={dto.map} mode={dto.mode} selectedCode={null} activeRouteCode={null}
