...
const EXPORT_CSS = `.lab-map-export{display:grid;grid-template-columns:280px minmax(0,1fr);gap:18px}.lab-map-export-controls{display:grid;align-content:start;gap:12px;padding:18px;border:1px solid var(--border);border-radius:14px;background:var(--card)}.lab-map-export-controls label{display:grid;gap:5px;font-size:12px;font-weight:700}.lab-map-export-controls select{min-height:42px;padding:7px 9px;border:1px solid var(--border);border-radius:8px;background:var(--card);color:var(--ink)}.lab-map-export-controls button{min-height:44px;border:0;border-radius:9px;background:#12324a;color:#fff;font:700 12px "Noto Sans Thai",sans-serif}.lab-map-export-controls button:disabled{opacity:.45}.lab-map-export-status{display:grid;padding:10px;border-left:4px solid #f0b429;background:var(--surface-2);font-size:12px}.lab-map-export-preview{overflow:auto;padding:14px;background:#cdd9dc;border-radius:14px;max-height:78vh}@media(max-width:850px){.lab-map-export{grid-template-columns:1fr}.lab-map-export-preview{max-height:65vh}}`
